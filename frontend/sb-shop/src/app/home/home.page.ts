...
import { spongebobepisodesmodel } from '../models/spongebobepisodesmodel';
...
export class HomePage implements OnInit {
  ...
  public spongebobepisodes: Array<spongebobepisodesmodel> = [];
  ...
  changeContent(content: string) {
    const episodesdiv = document.getElementById('episodes') as HTMLElement;
    const productsdiv = document.getElementById('products') as HTMLElement;
  ...
  loadEpisodes() {
    this.spongebobservice
      .getAllEpisodes()
      .subscribe((b: Array<spongebobepisodesmodel>) => {
  ...
  like(b) {
    let heart: string = '../../assets/images/heartred.png';
    if (b.liked != '../../assets/images/heartred.png') {
      heart = '../../assets/images/heartred.png';
    } else {
      heart = '../../assets/images/heartwhite.png';
    }
    const episode: spongebobepisodesmodel = {
      idspongebobepisodes: b.id,
      name: b.name,
      image: b.image,
      liked: heart,
    };
    this.spongebobservice.updateEpisode(episode).subscribe(() => {
      this.loadEpisodes();
    });
  }
